...
2. **Algorithms:** AES-128, AES-256, ChaCha20 (3 symmetric algorithms)
3. **File Types:** txt, jpg, png, mp4, pdf, zip, sql (7 types)
4. **File Sizes:** 64B, 1KB, 10KB, 100KB, 1MB, 10MB, 100MB (7 sizes)
5. **Runs per config:** 100 repetitions minimum
6. **Target measurements:** 14,700 total (3 algorithms × 7 file types × 7 sizes × 100 runs)
...
- Use standard padding schemes (PKCS7 for block ciphers)
